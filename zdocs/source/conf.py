...
htmlhelp_basename = "stalkgatewaydoc"
...
latex_documents = [
    (master_doc, "stalkgateway.text", "stalkgateway Documentation", "Billy Peake", "manual")
]
...
man_pages = [(master_doc, "stalkgateway", "stalkgateway Documentation", 1)]

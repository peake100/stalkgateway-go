...
.PHONY: proto
proto:
	protoc --go_out=plugins=grpc:./protogen --go_opt=paths=source_relative ./stalk_proto/forecaster.proto ./stalk_proto/reporter.proto ./stalk_proto/models.proto
	protoc -I. --grpc-gateway_out=logtostderr=true,paths=source_relative:./protogen ./stalk_proto/forecaster.proto ./stalk_proto/reporter.proto ./stalk_proto/models.proto

.PHONY: image-dev
image-dev:
	DOCKER_BUILDKIT=1 docker build \
	--no-cache \
	-t bpeake89/stalkgateway:dev .
